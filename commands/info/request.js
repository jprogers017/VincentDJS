...
class RequestCommand extends Commando.Command {
    ...
    async run(message) {
        ...
        if (!message.guild.me.hasPermission('SEND_MESSAGES')) {
            ...
            return message.say(`To properly use this command type in... "**${this.client.commandPrefix}request**" followed by what you would like to make a request for! For example, "**${this.client.commandPrefix}request** *new cow jokes!*" to send a request in for "*new cow jokes!*"`);
        } else {
